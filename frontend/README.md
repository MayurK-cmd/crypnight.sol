...
- Phantom wallet connection sets `auth_token` httpOnly cookie
...
const url = `${protocol}//${window.location.hostname}:5000/ws/duel`;
```
...
3. That player's board should blur with "Waiting for opponent to finish"
4. Other player continues playing and wins
5. Winner sees victory screen
